...
const (
	...
	MessageType_MessageType_WiseplatGetAddress       MessageType = 56
	MessageType_MessageType_WiseplatAddress          MessageType = 57
	MessageType_MessageType_WiseplatSignTx           MessageType = 58
	MessageType_MessageType_WiseplatTxRequest        MessageType = 59
	MessageType_MessageType_WiseplatTxAck            MessageType = 60
	...
	MessageType_MessageType_WiseplatSignMessage      MessageType = 64
	MessageType_MessageType_WiseplatVerifyMessage    MessageType = 65
	MessageType_MessageType_WiseplatMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_WiseplatGetAddress",
	57:  "MessageType_WiseplatAddress",
	58:  "MessageType_WiseplatSignTx",
	59:  "MessageType_WiseplatTxRequest",
	60:  "MessageType_WiseplatTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_WiseplatSignMessage",
	65:  "MessageType_WiseplatVerifyMessage",
	66:  "MessageType_WiseplatMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_WiseplatGetAddress":       56,
	"MessageType_WiseplatAddress":          57,
	"MessageType_WiseplatSignTx":           58,
	"MessageType_WiseplatTxRequest":        59,
	"MessageType_WiseplatTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_WiseplatSignMessage":      64,
	"MessageType_WiseplatVerifyMessage":    65,
	"MessageType_WiseplatMessageSignature": 66,
...
// *
// Request: Ask device for Wiseplat address corresponding to address_n path
// @next PassphraseRequest
// @next WiseplatAddress
// @next Failure
type WiseplatGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *WiseplatGetAddress) Reset()                    { *m = WiseplatGetAddress{} }
func (m *WiseplatGetAddress) String() string            { return proto.CompactTextString(m) }
func (*WiseplatGetAddress) ProtoMessage()               {}
func (*WiseplatGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *WiseplatGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *WiseplatGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Wiseplat address derived from device private seed
// @prev WiseplatGetAddress
type WiseplatAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *WiseplatAddress) Reset()                    { *m = WiseplatAddress{} }
func (m *WiseplatAddress) String() string            { return proto.CompactTextString(m) }
func (*WiseplatAddress) ProtoMessage()               {}
func (*WiseplatAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *WiseplatAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next WiseplatTxRequest
// @next Failure
type WiseplatSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *WiseplatSignTx) Reset()                    { *m = WiseplatSignTx{} }
func (m *WiseplatSignTx) String() string            { return proto.CompactTextString(m) }
func (*WiseplatSignTx) ProtoMessage()               {}
func (*WiseplatSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *WiseplatSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *WiseplatSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *WiseplatSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *WiseplatSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *WiseplatSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *WiseplatSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *WiseplatSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *WiseplatSignTx) GetDataLength() uint32 {
...
func (m *WiseplatSignTx) GetChainId() uint32 {
...
func (m *WiseplatTxRequest) Reset()                    { *m = WiseplatTxRequest{} }
func (m *WiseplatTxRequest) String() string            { return proto.CompactTextString(m) }
func (*WiseplatTxRequest) ProtoMessage()               {}
func (*WiseplatTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *WiseplatTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *WiseplatTxRequest) GetSignatureV() uint32 {
...
func (m *WiseplatTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *WiseplatTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev WiseplatTxRequest
// @next WiseplatTxRequest
type WiseplatTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *WiseplatTxAck) Reset()                    { *m = WiseplatTxAck{} }
func (m *WiseplatTxAck) String() string            { return proto.CompactTextString(m) }
func (*WiseplatTxAck) ProtoMessage()               {}
func (*WiseplatTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *WiseplatTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next WiseplatMessageSignature
// @next Failure
type WiseplatSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *WiseplatSignMessage) Reset()                    { *m = WiseplatSignMessage{} }
func (m *WiseplatSignMessage) String() string            { return proto.CompactTextString(m) }
func (*WiseplatSignMessage) ProtoMessage()               {}
func (*WiseplatSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *WiseplatSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *WiseplatSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type WiseplatVerifyMessage struct {
...
func (m *WiseplatVerifyMessage) Reset()                    { *m = WiseplatVerifyMessage{} }
func (m *WiseplatVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*WiseplatVerifyMessage) ProtoMessage()               {}
func (*WiseplatVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *WiseplatVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *WiseplatVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *WiseplatVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev WiseplatSignMessage
type WiseplatMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *WiseplatMessageSignature) Reset()                    { *m = WiseplatMessageSignature{} }
func (m *WiseplatMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*WiseplatMessageSignature) ProtoMessage()               {}
func (*WiseplatMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *WiseplatMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *WiseplatMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*WiseplatGetAddress)(nil), "WiseplatGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*WiseplatAddress)(nil), "WiseplatAddress")
	...
	proto.RegisterType((*WiseplatSignTx)(nil), "WiseplatSignTx")
	proto.RegisterType((*WiseplatTxRequest)(nil), "WiseplatTxRequest")
	proto.RegisterType((*WiseplatTxAck)(nil), "WiseplatTxAck")
	proto.RegisterType((*WiseplatSignMessage)(nil), "WiseplatSignMessage")
	proto.RegisterType((*WiseplatVerifyMessage)(nil), "WiseplatVerifyMessage")
	proto.RegisterType((*WiseplatMessageSignature)(nil), "WiseplatMessageSignature")
