...
// Package accounts implements high level Wiseplat account management.
package accounts
...
// Account represents an Wiseplat account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Wiseplat account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain wiseplat.ChainStateReader)
