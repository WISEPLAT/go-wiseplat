...
// Package bind generates Wiseplat contract Go bindings.
//
// Detailed usage document and tutorial available on the go-wiseplat Wiki page:
// https://github.com/wiseplat/go-wiseplat/wiki/Native-DApps:-Go-bindings-to-Wiseplat-contracts
package bind
