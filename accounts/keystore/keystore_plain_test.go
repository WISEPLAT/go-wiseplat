...
func tmpKeyStoreIface(t *testing.T, encrypted bool) (dir string, ks keyStore) {
	d, err := ioutil.TempDir("", "gwsh-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
	if encrypted {
...
// Test and utils for the key store tests in the Wiseplat JSON tests;
