...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/wiseplat/pywshsaletool

		pywshsaletool generates the encryption key from password by
	...
	*/
	...
	wshPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(wshPriv)
	...
	expectedAddr := preSaleKeyStruct.WshAddr
