...
// See https://github.com/wiseplat/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Wiseplat presale wallet and stores
