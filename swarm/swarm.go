...
import (
	...
	"github.com/wiseplat/go-wiseplat/contracts/chequebook"
	...
	"github.com/wiseplat/go-wiseplat/swarm/api"
	httpapi "github.com/wiseplat/go-wiseplat/swarm/api/http"
	"github.com/wiseplat/go-wiseplat/swarm/fuse"
	"github.com/wiseplat/go-wiseplat/swarm/network"
	"github.com/wiseplat/go-wiseplat/swarm/storage"
)
...
func NewSwarm(ctx *node.ServiceContext, backend chequebook.Backend, ensClient *wshclient.Client, config *api.Config, swapEnabled, syncEnabled bool, cors string) (self *Swarm, err error) {
