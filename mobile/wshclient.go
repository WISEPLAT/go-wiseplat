...
// Contains a wrapper for the Wiseplat client.
...
import (
	...
	"github.com/wiseplat/go-wiseplat/wshclient"
)

// WiseplatClient provides access to the Wiseplat APIs.
type WiseplatClient struct {
	client *wshclient.Client
}

// NewWiseplatClient connects a client to the given URL.
func NewWiseplatClient(rawurl string) (client *WiseplatClient, _ error) {
	rawClient, err := wshclient.Dial(rawurl)
	return &WiseplatClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *WiseplatClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *WiseplatClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *WiseplatClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *WiseplatClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *WiseplatClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *WiseplatClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *WiseplatClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *WiseplatClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *WiseplatClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *WiseplatClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *WiseplatClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *WiseplatClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *WiseplatClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *WiseplatClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *WiseplatClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *WiseplatClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *WiseplatClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *WiseplatClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *WiseplatClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *WiseplatClient) EstimateGas(ctx *Context, msg *CallMsg) (gas *BigInt, _ error) {
...
func (ec *WiseplatClient) SendTransaction(ctx *Context, tx *Transaction) error {
