...
// Contains all the wrappers from the go-wiseplat root package.
...
// the Wiseplat network.
type SyncProgress struct {
	progress wiseplat.SyncProgress
}
