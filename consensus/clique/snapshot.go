...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db wshdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db wshdb.Database) error {
