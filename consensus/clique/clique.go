...
// ecrecover extracts the Wiseplat account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Wiseplat address
...
// Wiseplat testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     wshdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Wiseplat address of the signing key
...
func New(config *params.CliqueConfig, db wshdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Wiseplat address recovered
