...
// cacheSize calculates and returns the size of the wshash verification cache that
...
// datasetSize calculates and returns the size of the wshash mining dataset that
