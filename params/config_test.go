...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllWshashProtocolChanges, new: AllWshashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllWshashProtocolChanges, new: AllWshashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllWshashProtocolChanges,
