...
var (
	...
	configPrefix   = []byte("wiseplat-config-") // config prefix for the db
...
func WriteCanonicalHash(db wshdb.Putter, hash common.Hash, number uint64) error {
...
func WriteHeadHeaderHash(db wshdb.Putter, hash common.Hash) error {
...
func WriteHeadBlockHash(db wshdb.Putter, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db wshdb.Putter, hash common.Hash) error {
...
func WriteHeader(db wshdb.Putter, header *types.Header) error {
...
func WriteBody(db wshdb.Putter, hash common.Hash, number uint64, body *types.Body) error {
...
func WriteBodyRLP(db wshdb.Putter, hash common.Hash, number uint64, rlp rlp.RawValue) error {
...
func WriteTd(db wshdb.Putter, hash common.Hash, number uint64, td *big.Int) error {
...
func WriteBlock(db wshdb.Putter, block *types.Block) error {
...
func WriteBlockReceipts(db wshdb.Putter, hash common.Hash, number uint64, receipts types.Receipts) error {
...
func WriteTxLookupEntries(db wshdb.Putter, block *types.Block) error {
...
func WriteBloomBits(db wshdb.Putter, bit uint, section uint64, head common.Hash, bits []byte) {
	key := append(append(bloomBitsPrefix, make([]byte, 10)...), head.Bytes()...)
...
func PreimageTable(db wshdb.Database) wshdb.Database {
	return wshdb.NewTable(db, preimagePrefix)
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db wshdb.Database, number uint64, preimages map[common.Hash][]byte) error {
...
func WriteBlockChainVersion(db wshdb.Putter, vsn int) {
	enc, _ := rlp.EncodeToBytes(uint(vsn))
	db.Put([]byte("BlockchainVersion"), enc)
}

// WriteChainConfig writes the chain config settings to the database.
func WriteChainConfig(db wshdb.Putter, hash common.Hash, cfg *params.ChainConfig) error {
