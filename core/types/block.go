...
// Package types contains data types related to Wiseplat consensus.
package types
...
// Header represents a block header in the Wiseplat blockchain.
type Header struct {
...
// Block represents an entire block in the Wiseplat blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package wsh to track
...
// [deprecated by wsh/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for wsh protocol, etc.
...
// DecodeRLP decodes the Wiseplat
...
// EncodeRLP serializes b into the Wiseplat RLP block format.
