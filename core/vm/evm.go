...
type Context struct {
	...
	// sufficient wise to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers wise from one account to the other
...
// EVM is the Wiseplat Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) wiseplat virtual machine
