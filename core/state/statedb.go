...
// Package state provides a caching layer atop the Wiseplat state trie.
package state
...
// StateDBs within the wiseplat protocol are used to store anything
...
//
// Carrying over the balance ensures that Wise doesn't disappear.
