...
// stateObject represents an Wiseplat account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of wiseplat address of the account
	data     Account
	db       *StateDB
...
// Account is the Wiseplat consensus representation of accounts.
