...
func makeTestState() (Database, *wshdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := wshdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db wshdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db wshdb.Database, root common.Hash) error {
...
func checkStateConsistency(db wshdb.Database, root common.Hash) error {
