...
//
// wsh_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// wsh_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.WshSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "wsh_getBlockByNumber", "latest"); err != nil {
