...
// Package tests implements execution of Wiseplat JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, config, wshash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/wiseplat/tests/wiki/Blockchain-Tests-II
