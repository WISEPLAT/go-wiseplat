...
type accessTestFn func(db wshdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db wshdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db wshdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db wshdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db wshdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
