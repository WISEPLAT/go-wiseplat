...
func NewLesOdr(db wshdb.Database, chtIndexer, bloomTrieIndexer, bloomIndexer *core.ChainIndexer, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:               db,
...
func (odr *LesOdr) Database() wshdb.Database {
	return odr.db
}
