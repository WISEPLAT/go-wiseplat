Name "gwsh ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/wiseplat/go-wiseplat/issues"
!define UPDATEURL "https://github.com/wiseplat/go-wiseplat/releases"
!define ABOUTURL "https://github.com/wiseplat/go-wiseplat#wiseplat-go"
...
# Install gwsh binary
Section "Gwsh" GWSH_IDX
  SetOutPath $INSTDIR
  file {{.Gwsh}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gwsh.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gwsh.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gwsh incoming peers (TCP:30373)" ""  6 1 1 2147483647 1 "$INSTDIR\gwsh.exe" "" "" "Wiseplat" 30373 "" "" ""
  SimpleFC::AdvAddRule "Gwsh outgoing peers (TCP:30373)" ""  6 2 1 2147483647 1 "$INSTDIR\gwsh.exe" "" "" "Wiseplat" "" 30373 "" ""
  SimpleFC::AdvAddRule "Gwsh UDP discovery (UDP:30373)" "" 17 2 1 2147483647 1 "$INSTDIR\gwsh.exe" "" "" "Wiseplat" "" 30373 "" ""

  # Set default IPC endpoint (https://github.com/wiseplat/EIPs/issues/147)
  ${EnvVarUpdate} $0 "WISEPLAT_SOCKET" "R" "HKLM" "\\.\pipe\gwsh.ipc"
  ${EnvVarUpdate} $0 "WISEPLAT_SOCKET" "A" "HKLM" "\\.\pipe\gwsh.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GWSH_IDX}
    SectionGetSize ${GWSH_IDX} $0
