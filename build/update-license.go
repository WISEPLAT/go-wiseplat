...
var (
	...
	authorsFileHeader = "# This is the official list of go-wiseplat authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-wiseplat Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-wiseplat library"
	}
	return "the go-wiseplat library"
}
