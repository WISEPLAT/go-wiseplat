...
# 1. install gwsh for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gwsh
# 5. create gwsh, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable WISEPLAT_SOCKET
...
!define APPNAME "Gwsh"
!define DESCRIPTION "Official Go implementation of the Wiseplat protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gwsh is installed global
