...
// Package chequebook package wraps the 'chequebook' Wiseplat smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in wise; (auto)cashing cheques in wise
// as well as (auto)depositing wise to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/wiseplat/go-wiseplat/contracts/chequebook/contract"
	"github.com/wiseplat/go-wiseplat/core/types"
	"github.com/wiseplat/go-wiseplat/crypto"
	"github.com/wiseplat/go-wiseplat/log"
	"github.com/wiseplat/go-wiseplat/swarm/services/swap/swap"
)
...
// * depositing wise to the chequebook
// * watching incoming wise
...
// Cash cashes the cheque by sending an Wiseplat transaction.
