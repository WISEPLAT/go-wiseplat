...
// ReleaseOracle is an Wiseplat contract to store the current and previous
// versions of the go-wiseplat implementation. Its goal is to allow Gwsh to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gwsh releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gwsh release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Wiseplat user, either
