...
// DeployReleaseOracle deploys a new Wiseplat contract, binding an instance of ReleaseOracle to it.
...
// ReleaseOracle is an auto generated Go binding around an Wiseplat contract.
...
// ReleaseOracleCaller is an auto generated read-only Go binding around an Wiseplat contract.
type ReleaseOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleTransactor is an auto generated write-only Go binding around an Wiseplat contract.
type ReleaseOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleSession is an auto generated Go binding around an Wiseplat contract,
...
// ReleaseOracleCallerSession is an auto generated read-only Go binding around an Wiseplat contract,
...
// ReleaseOracleTransactorSession is an auto generated write-only Go binding around an Wiseplat contract,
...
// ReleaseOracleRaw is an auto generated low-level Go binding around an Wiseplat contract.
type ReleaseOracleRaw struct {
	Contract *ReleaseOracle // Generic contract binding to access the raw methods on
}

// ReleaseOracleCallerRaw is an auto generated low-level read-only Go binding around an Wiseplat contract.
...
// ReleaseOracleTransactorRaw is an auto generated low-level write-only Go binding around an Wiseplat contract.
