...
// information related to the Wiseplat protocol such als blocks, transactions and logs.
...
// `wsh_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with wsh_getFilterChanges.
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_newblockfilter
...
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_newfilter
...
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_getlogs
...
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_uninstallfilter
...
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_getfilterlogs
...
//
// https://github.com/wiseplat/wiki/wiki/JSON-RPC#wsh_getfilterchanges
