...
// PeerInfo represents a short summary of the Wiseplat sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Wiseplat protocol version negotiated
...
// Handshake executes the wsh protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("wsh/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Wiseplat sub-protocol.
type peerSet struct {
