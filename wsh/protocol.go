...
var ProtocolName = "wsh"

// Supported versions of the wsh protocol (first is primary).
var ProtocolVersions = []uint{wsh63, wsh62}
...
// wsh protocol message codes
const (
	// Protocol messages belonging to wsh/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to wsh/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
