...
type Fetcher struct {
	...
	fetchingHook       func([]common.Hash)     // Method to call upon starting a block (wsh/61) or header (wsh/62) fetch
	completingHook     func([]common.Hash)     // Method to call upon starting a block body fetch (wsh/62)
	importedHook       func(*types.Block)      // Method to call upon successful block import (both wsh/61 and wsh/62)
}
