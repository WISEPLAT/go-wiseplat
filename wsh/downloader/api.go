...
// Syncing provides information when this nodes starts synchronising with the Wiseplat network and when it's finished.
...
type SyncingResult struct {
	...
	Status  wiseplat.SyncProgress `json:"status"`
}
