...
type downloadTester struct {
	...
	stateDb wshdb.Database // Database used by the tester for syncing from peers
	peerDb  wshdb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb, _ = wshdb.NewMemDatabase()
