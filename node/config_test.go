...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gwsh.ipc", false, filepath.Join(os.TempDir(), "gwsh.ipc")},
		{"data", "gwsh.ipc", false, "data/gwsh.ipc"},
		{"data", "./gwsh.ipc", false, "./gwsh.ipc"},
		{"data", "/gwsh.ipc", false, "/gwsh.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gwsh.ipc", true, `\\.\pipe\gwsh.ipc`},
		{"data", "gwsh.ipc", true, `\\.\pipe\gwsh.ipc`},
		{"data", `\\.\pipe\gwsh.ipc`, true, `\\.\pipe\gwsh.ipc`},
	}
