...
import (
	...
	"github.com/wiseplat/go-wiseplat/logger"
	"github.com/wiseplat/go-wiseplat/p2p"
	"github.com/wiseplat/go-wiseplat/p2p/nat"
	"github.com/wiseplat/go-wiseplat/whisper"
)
...
func main() {
	...
	// Create an Wiseplat peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Wiseplat peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Wiseplat peer: %v.\n", err)
		os.Exit(1)
	}
