...
import (
	...
	"github.com/wiseplat/go-wiseplat/crypto/ecies"
	"github.com/wiseplat/go-wiseplat/event/filter"
...
// Whisper represents a dark communication interface through the Wiseplat
...
// New creates a Whisper client ready to communicate through the Wiseplat P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
